        ...
        this.container.innerHTML = `
            <div class="player-container">
                <div class="album-cover">
                    <img src="https://is1-ssl.mzstatic.com/image/thumb/Music221/v4/cb/f6/34/cbf6347b-65ad-53f1-4a5e-e9eb2f64133d/cover.png/600x600bf-60.jpg" alt="Обложка альбома Кошки Бильярд">
                </div>
                <div class="progress-container">
                    <div class="progress-bar" id="progressBar-player">
                        <div class="progress" id="progress-player"></div>
                    </div>
                    <div class="time-info">
                        <span id="currentTime-player">0:00</span>
                        <span id="duration-player">0:00</span>
                    </div>
                </div>
                
                <div class="controls">
                    <button class="control-btn" id="prevBtn-player">⏮</button>
                    <button class="control-btn play-btn" id="playBtn-player">▶</button>
                    <button class="control-btn" id="nextBtn-player">⏭</button>
                </div>
                
                <div class="volume-container">
                    <input type="range" class="volume-slider" id="volumeSlider-player" min="0" max="1" step="0.1" value="0.7">
                    <span class="volume-value" id="volumeValue-player">70%</span>
                </div>
                
                <div class="playlist">
                    <h3>Треки альбома "Кошки Бильярд"</h3>
                    <ul id="playlist-player"></ul>
                </div>
                
                <audio id="audioPlayer-player"></audio>
            </div>
        `;

        this.elements = {
            audioPlayer: document.getElementById('audioPlayer-player'),
            playBtn: document.getElementById('playBtn-player'),
            prevBtn: document.getElementById('prevBtn-player'),
            nextBtn: document.getElementById('nextBtn-player'),
            progressBar: document.getElementById('progressBar-player'),
            progress: document.getElementById('progress-player'),
            currentTimeEl: document.getElementById('currentTime-player'),
            durationEl: document.getElementById('duration-player'),
            volumeSlider: document.getElementById('volumeSlider-player'),
            volumeValue: document.getElementById('volumeValue-player'),
            playlistEl: document.getElementById('playlist-player'),
